...
{
    partial class TestChartTop10productos
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Top Productos Más Vendidos";
            ...
            lblTitulo.Text = "Top Productos Vendidos";
            ...
            lblSubtitulo.Text = "Ranking de productos por unidades vendidas en el período";
            ...
            void ConfigurarCard(System.Windows.Forms.Panel card,
                                 ...
                                 string titulo, int x)
            {
                card.Size = new System.Drawing.Size(220, 68);
                ...
                valLbl.Text = "—";
                valLbl.Font = new System.Drawing.Font("Segoe UI", 15F, System.Drawing.FontStyle.Bold);
            ...
            ConfigurarCard(cardTotal, lblTotalTxt, lblTotalVal, "TOTAL UNIDADES VENDIDAS", 20);
            ConfigurarCard(cardPromedio, lblPromedioTxt, lblPromedioVal, "PROMEDIO POR PRODUCTO", 260);
            ConfigurarCard(cardMaximo, lblMaximoTxt, lblMaximoVal, "PRODUCTO TOP", 500);
